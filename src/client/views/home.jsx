...
const Home = () => {
  ...
  // Clonamos la primera imagen para un bucle infinito fluido
  const imagenes = [...imagenesOriginales, imagenesOriginales[0]];
      ...
      <main className="container-main">
        ...
        <div className="container-video-text">
          ...
          <img
            ...
            src="/constelaciones.webp"
            alt=""
          />
          <img
            className="constelaciones img2"
            src="/constelaciones2.webp"
            alt=""
          />
        </div>
        ...
        <div className="container-galery-text">
          <div className="text-galery">
            ...
            <p>
              ...
              estar separados por la distancia, siempre podrán mirar al cielo y
              observar las mismas estrellas.
            </p>
            <p>
          ...
          <div className="container-galery">
            <div
              className="slider-galeria-wrapper"
            ...
            >
              {imagenes.map((src, i) => {
                const esActivo =
                  i === index ||
                  (index === imagenesOriginales.length && i === 0);

                // Lógica de clases para las imágenes 2, 5 y 6
                let claseEspecial = "";
                if (i + 1 === 2 || i + 1 === 5 || i + 1 === 6) {
                  claseEspecial = "ajuste-cuadro";
                }

                return (
                  <img
                    key={i}
                    className={`image-galery ${esActivo ? "opacity-viva" : ""} ${claseEspecial}`}
                    src={src}
                    alt={`Galería ${i}`}
                  />
                );
