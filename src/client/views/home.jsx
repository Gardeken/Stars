    ...
    <Fragment>
      ...
      <main className="container-main">
        ...
        <div className="container-video-text">
          ...
          <img className="constelaciones img1" src="/constelaciones.webp" />
          <img className="constelaciones img2" src="/constelaciones2.webp" />
        </div>
